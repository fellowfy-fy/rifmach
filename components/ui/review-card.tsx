...
export default function ReviewCard({ review }: ReviewCardProps) { 
  ...
  return (
    <div className="border hover:border-main w-full md:w-auto  lg:w-[380px] min-h-[445px] flex flex-col justify-between pl-[25px] pr-[30px] pb-[20px] pt-[40px] rounded-[5px] relative mb-[39px] md:mb-0">

...
export default function AuthorCard({ author }: AuthorCardProps) {
  ...
  return (
    <div className="border transition-colors duration-300 hover:border-main bg-white w-auto md:w-[280px] pl-[25px] pr-[30px] py-[40px] rounded-[5px] relative mb-[9px] md:mb-0 flex items-center flex-col ">

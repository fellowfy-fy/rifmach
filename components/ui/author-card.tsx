...
export default function AuthorCard({ author }: AuthorCardProps) {
  ...
  return (
    <div className="border bg-white w-[280px] h-[350px] pl-[25px] pr-[30px] py-[40px] rounded-[5px] relative mb-[39px] md:mb-0 flex items-center flex-col">
      ...
      <p className="text-h4 text-textsmain mt-[11px] leading-5">
        {authorText}
      </p>
    </div>
  );

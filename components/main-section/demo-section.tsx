...
export default function DemoSection() {
  return (
    <div className="bg-gradient-to-r from-[#70B3FF] to-[#70DBFC] ">
      <section className="relative px-[16px] md:px-[40px] lg:px-[80px] xl:px-[140px] h-[1000px] md:h-[992px] overflow-hidden items-center">
        ...
        <div className="relative top-[101px] md:top-[97px]">
          ...
          <h3 className="text-h3 md:text-[18px] text-white mt-4 regular max-w-[600px]">
            Вы достойны стихов, написанных по всем законам стихосложения:
            качественные интересные рифмы, необычные образы, точный ритм
          </h3>
        </div>
      </section>
      <ArchBottom />
